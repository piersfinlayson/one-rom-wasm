...
export const wasm_bindgen__convert__closures_____invoke__h62b08efba5b8ccbc: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__h03d91b42a8362058: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h0b1e7be60adc2140: (a: number, b: number, c: any, d: any) => void;
