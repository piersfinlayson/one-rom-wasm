...
export const wasm_bindgen__closure__destroy__he35ed55885a1e80f: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h2ffd44f11778632b: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__h121f56a0a63d3a9a: (a: number, b: number, c: any, d: any) => void;
