...
export const wasm_bindgen__convert__closures_____invoke__habc0da91ec84b911: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__h07ff1e7d3a5a188f: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h32409a7d5065ec7f: (a: number, b: number, c: any, d: any) => void;
