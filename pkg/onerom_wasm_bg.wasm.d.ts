...
export const wasm_bindgen__convert__closures_____invoke__h93088125145ef9e5: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__h39a2dc533aa37487: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h091474265ae9cc6a: (a: number, b: number, c: any, d: any) => void;
