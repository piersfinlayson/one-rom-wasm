...
export const wasm_bindgen__convert__closures_____invoke__h01208759846829b6: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__h2d7a692b2200149a: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h1518d5956c1b7432: (a: number, b: number, c: any, d: any) => void;
