...
export const wasm_bindgen__closure__destroy__hf4b5e92d38978907: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__haec7b660a6511385: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__hd4680ea21377bdcc: (a: number, b: number, c: any, d: any) => void;
