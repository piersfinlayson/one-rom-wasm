...
export const wasm_bindgen__closure__destroy__hd25ccd7fccf7e548: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h3503a4b842f88e79: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__h7272d9fce4aa722a: (a: number, b: number, c: any, d: any) => void;
