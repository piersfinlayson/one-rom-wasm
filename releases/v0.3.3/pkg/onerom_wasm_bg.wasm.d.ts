...
export const wasm_bindgen__closure__destroy__h7d44e624db16218f: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h96f7bead99216ffa: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__h117440691037b0ec: (a: number, b: number, c: any, d: any) => void;
